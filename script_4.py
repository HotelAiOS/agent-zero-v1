...
with open('verify_environment.py', 'w') as f:
    f.write(verify_script)

os.chmod('verify_environment.py', 0o755)

print("✅ Created verify_environment.py")
print("📋 Verification features:")
print("- Docker container status check")
print("- Neo4j/Redis/RabbitMQ connection tests")
print("- HTTP endpoint availability")
